...
def mycelia_dict(params):
    ...
    mycelia = {
        ...
        # Spatial index mapping each occupied external grid cell -> list of
        # segment indices located there. Maintained incrementally by
        # growth_functions._register_on_grid.
        'grid_cell_map': {}
        }
